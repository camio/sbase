...
SOURCES += src/smisc_point2d.cpp
SOURCES += src/smisc_point2dnormedvectorspace.cpp
SOURCES += src/smisc_point2dvectorspace.cpp
SOURCES += src/smisc_point2dserialize.cpp
