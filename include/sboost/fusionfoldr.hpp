...
namespace sboost
{
    namespace fusion
    {
        namespace result_of
        {
            ...
            struct foldr1
            {
                ...
                typedef typename boost::fusion::result_of::fold< Sequence2
                                                               , State
                                                               , F
                                                               >::type type;
            };
        ...
        template< typename Sequence, typename F >
        typename result_of::foldr1<Sequence,F>::type
        foldr1( Sequence & seq
              , F const & f
              )
        {
            using namespace boost::fusion;
            return fold( pop_front( seq )
                       , front( seq )
                       , f
                       );
        }
    ...
    namespace fusion
    {
        ...
        template< typename Sequence, typename F >
        typename result_of::foldl1<Sequence,F>::type
        foldl1( Sequence & seq
              , F const & f
              )
        {
            using namespace boost::fusion;
            return reverse_fold( pop_back( seq )
                               , back( seq )
                               , f
                               );
        }
